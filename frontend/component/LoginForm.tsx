    ...
    public render(){
        ...
        onFinish={this.onFinish} >
            <Form.Item name="username" rules={[ { required: true, message: '请输入你的账号!', }, ]} > 
                <Input type="username"  prefix={<UserOutlined className="site-form-item-icon" />} placeholder="账号" /> 
            </Form.Item>
            ...
            >
                <Input prefix={<LockOutlined className="site-form-ite-icon" />} type="password" placeholder="密码" />
            </Form.Item>
            <Form.Item>
                <Form.Item name={styles.remember} valuePropName="checked" noStyle> 
                <Checkbox className={styles.loginformremeber}>记住账号</Checkbox> 
                </Form.Item>
                <span className={styles.loginformforgot} onClick={this.toggleForm1}> 忘记账号/密码</span>
            </Form.Item>
            <Form.Item>
                <Button type="primary" 
                htmlType="submit" 
